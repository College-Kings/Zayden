        ...
        if (id) {
            if (rules[id]) {
                const embed = new Discord.MessageEmbed()
                    .setTitle(`Rule ${id}`)
                    .setColor("ff0000")
                    .setDescription(`**${rules[id]}**\n\n**Please don't forget to read the rest of the rules!`)
                    .setThumbnail("https://images-ext-2.discordapp.net/external/QOCCliX2PNqo717REOwxtbvIrxVV2DZ1CRc8Svz3vUs/https/collegekingsgame.com/wp-content/uploads/2020/08/college-kings-wide-white.png?width=1440&height=566")
                    .setTimestamp()

                message.reply(embed);
            } else {
                message.reply(`I couldn't find a rule with the number ${id}`);
            }
        } else {
            message.reply("Please provide a rule id!");
        }
    },
    permissions: [],
    requiredRoles: [],
