...
pub const GENERAL_CHANNEL_ID: ChannelId = ChannelId::new(745662813036609548);
...
pub const SUPPORT_CHANNEL_ID: ChannelId = ChannelId::new(919950775134847016);

pub const ARTIST_ROLE_ID: RoleId = RoleId::new(1043987303556726854);
