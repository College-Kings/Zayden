...
module.exports = {
    log: function (client: Discord.Client, oldMember: Discord.GuildMember, newMember: Discord.GuildMember) {
        ...
        if (oldMember.roles.cache.size < newMember.roles.cache.size) {
            const embed1 = new Discord.MessageEmbed()
                ...
                .setFooter({text: newMember.guild.name, iconURL: guild.iconURL({dynamic: true}) || undefined})
                ...
                if (!oldMember.roles.cache.has(role)) {
                    if (patreonRoles[role]) {
                        const embed2 = new Discord.MessageEmbed()
                            .setTitle("New Patron")
                            .setColor(newMember.guild.roles.cache.get(role)?.hexColor || "#000")
                            .setFooter({
