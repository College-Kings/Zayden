...
module.exports = {
    ...
    callback: (message: Discord.Message, args: string[], text: string) => {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField(`__Patreon Release__ (${server.gameVersions.patreonVersion})`, server.gameVersions.patreonUpdate, true)
            .addField(`__Steam Release__ (${server.gameVersions.steamVersion})`, server.gameVersions.steamUpdate, true)
